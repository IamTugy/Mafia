...
export const DAY_START_DURATION_MS = 6000;           // how long day.start is shown before discussion
export const NIGHT_TRANSITION_DELAY_MS = 2000;       // pause between night sub-phases (fake delay)
export const MAFIA_SETUP_TIMEOUT_MS = 45000;         // fallback if not all mafia press Done
